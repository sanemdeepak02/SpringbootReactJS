...
//   }
  ...
  @SuppressWarnings("null")
  @Transactional()
   public List<employees> transToGetBUbyVol( String tcName, String tcStatus, String dataresrveBy, Integer envid, String bUnitValue, Integer limit){
    
    List<employees> emp = empRepo.getActEmpByNum(envid,bUnitValue,limit);
    System.out.println("Thsi is employee record" + emp.get(0));

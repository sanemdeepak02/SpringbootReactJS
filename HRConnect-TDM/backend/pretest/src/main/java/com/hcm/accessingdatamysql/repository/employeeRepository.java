...
public interface employeeRepository extends JpaRepository<employees,Integer> {
    ...
    //@Query("SELECT n from employeess n WHERE n.assgStatus='Active - Payroll Eligible' AND n.reserve_By is null AND n.buName=:buName ORDER BY n.buName DESC LIMIT 1")
    ...
    // @Query("SELECT n from employees n WHERE n.envid=:envid AND n.assgStatus='Active - Payroll Eligible' AND n.reserve_By is null AND n.buName=:buName ORDER BY n.buName DESC LIMIT 1")
    // public List<employees> getActEmpByBU(Integer envid, String buName);


    @Query("SELECT n from employees n WHERE n.envid=:envid AND n.assgStatus='Active - Payroll Eligible' AND n.reserve_By is null AND n.buName=:buName ORDER BY n.buName DESC LIMIT :limit")
    public List<employees> getActEmpByNum(Integer envid, String buName, Integer limit);

...
public class employeeService {
   ...
   @SuppressWarnings("null")
   @Transactional()
    public List<employee> transToGetBUbyEmp( String tcName, String tcStatus, String dataresrveBy, Integer envid, String bUnitValue){
  ...
  @SuppressWarnings("null")
  @Transactional()
   public List<employee> transToGetBUbyVol( String tcName, String tcStatus, String dataresrveBy, Integer envid, String bUnitValue, Integer limit){

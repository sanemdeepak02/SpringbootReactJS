...
public interface employeeRepository extends JpaRepository<employees,Integer> {
    ...
    @Query("SELECT n from employees n WHERE n.env_id=:envid AND n.assgStatus='Active - Payroll Eligible' AND n.reserve_By is null AND n.buName=:buName ORDER BY n.buName DESC LIMIT 1")

...
public class employeeController {
   ...
   @PostMapping("/addEmp")
   public employee postEmpDetails(@RequestBody employee empInfo){
    return empService.saveEmpInfo(empInfo);
   }

   @CrossOrigin(origins = "http://localhost:3000")
   @GetMapping("/all")
   public List<employee> fethController(){      
   ...
   public List<employee> getActiveEmp(@PathVariable String buName){
   ...
   public List<employee> getActiveBU(@RequestParam Map<String,String> multiParams){
      ...
      //  return empService.transToGetBUbyEmp(list.get(0),list.get(1),list.get(2),Integer.parseInt(list.get(3)),list.get(4));
       ...
       //************************* */
       List<String> listVol = new ArrayList<String>(multiParams.values());
       System.out.print("listVol Size...: " + listVol.size());
       if(listVol.size()>5){
         System.out.print("This is the size of listVol (getEmpBUnit) is more than 5" + listVol.size());
         System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) );
         // return empService.fetchAll();
          return empService.transToGetBUbyEmp(listVol.get(0),listVol.get(1),listVol.get(2),Integer.parseInt(listVol.get(3)),listVol.get(4),"no");
       }else{
         System.out.print("This is the size of listVol (getEmpBUnit) is equal to 5" + listVol.size());
         System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) ); 
         // return empService.fetchAll();
          return empService.transToGetBUbyEmp(listVol.get(0),listVol.get(1),listVol.get(2),Integer.parseInt(listVol.get(3)),listVol.get(4),"yes");
    ...
    //Work in progress code:
    @GetMapping("getEmpBUbyVol/")
   
    public List<employee> getActiveBUVol(@RequestParam Map<String,String> multiParams){
       System.out.println(multiParams.values());
       List<String> listVol = new ArrayList<String>(multiParams.values());
       System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5) );
       // return empService.fetchAll();
        return empService.transToGetBUbyVol(listVol.get(0),listVol.get(1),listVol.get(2),Integer.parseInt(listVol.get(3)),listVol.get(4),Integer.parseInt(listVol.get(5)));
    
      
    
      }

    @GetMapping("getEmpBUCity/")
   
    public List<employee> getEmpBUcity(@RequestParam Map<String,String> multiParams){
       System.out.println(multiParams.values());
       
       
      //  List<String> listVol = new ArrayList<String>(multiParams.values());
      //  System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  ); //transToGetBUbyParams
      //  // return empService.fetchAll();
      //   return empService.transToGetBUcity(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), listVol.get(5));
    
      //************************* */
      List<String> listVol = new ArrayList<String>(multiParams.values());
      if(listVol.size()>6){
        System.out.print("This is the size of listVol is more than 6" + listVol.size());
        System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  );
        // return empService.fetchAll();
        return empService.transToGetBUcity(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), listVol.get(5),"no");
      }else{
        System.out.print("This is the size of listVol is equal to 6" + listVol.size());
        System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  ); 
        // return empService.fetchAll();
        return empService.transToGetBUcity(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), listVol.get(5),"yes");
    ...
    @GetMapping("getEmpBUjobCode/")
   
    public List<employee> getBUjobCode(@RequestParam Map<String,String> multiParams){
      //  System.out.println(multiParams.values());
      //  List<String> listVol = new ArrayList<String>(multiParams.values());
      //  System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  ); //transToGetBUbyParams
      //  // return empService.fetchAll();
      //   return empService.transToGetBUjobCode(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), Integer.parseInt(listVol.get(5)));
        ...
        if(listVol.size()>6){
          ...
          System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  ); //transToGetBUbyParams
          // return empService.fetchAll();
           return empService.transToGetBUjobCode(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), Integer.parseInt(listVol.get(5)),"no");
        }else{
          System.out.print("This is the size of listVol is equal to 6" + listVol.size());
          System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5)  ); //transToGetBUbyParams
          // return empService.fetchAll();
           return empService.transToGetBUjobCode(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), Integer.parseInt(listVol.get(5)),"yes");
    ...
    @GetMapping("getEmpBUConditions/")
   
    public List<employee> getByConditions(@RequestParam Map<String,String> multiParams){
       System.out.println(multiParams.values());
       List<String> listVol = new ArrayList<String>(multiParams.values());
       if(listVol.size()>7){
         System.out.print("This is the size of listVol is more than 6" + listVol.size());
         System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5) +  listVol.get(6)  ); //transToGetBUbyParams
         // return empService.fetchAll();
          return empService.transToGetBUbyParams(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), Integer.parseInt(listVol.get(5)),listVol.get(6),"no");
       }else{
         System.out.print("This is the size of listVol is equal to 6" + listVol.size());
         System.out.println(listVol.get(0) + ".." + listVol.get(1) + "...." + listVol.get(2) + listVol.get(3) + listVol.get(4) + listVol.get(5) +  listVol.get(6)  ); //transToGetBUbyParams
         // return empService.fetchAll();
          return empService.transToGetBUbyParams(Integer.parseInt(listVol.get(0)),listVol.get(1),listVol.get(2),listVol.get(3),listVol.get(4), Integer.parseInt(listVol.get(5)),listVol.get(6),"yes");
